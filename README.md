...
you can use "_beginthreadex " function in "msvcrt.dll" to create Thread and this code working very well and this code not detected by Windows Defender with last updates . 
